...
export default function TravelPlansPage() {
  ...
  const getDayPlanning = (day) => {
    ...
    return {
      ...
      overview:
        `Day ${day?.day || ""} includes ${
          places.length
        } main place${
          places.length === 1
            ? ""
            : "s"
        } with planned food breaks.`,
  ...
  const selectPlan = (plan) => {
    ...
    if (!currentUser) {
      ...
      /*
        Save the page where the user came from.

        After successful login,
        AuthPage will return the user here.
      */
  ...
  return (
    <>
      ...
      <main
        className="travel-plan-page-scope"
      >
